...
//!
//! \note VMX registers v0..v31 alias VSRs 32..63. The register allocator
//! shares a single 32-register vector group between FPRs, VMX, and VSX
//! registers (ids 0..31), so FPR fN and VMX vN have the same allocator id
//! even though they are different physical registers.
class Vr : public Reg {
public:
